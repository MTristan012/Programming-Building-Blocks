...
#Backgrounds
backgroundBeach = Image.open("beach.jpg")
backgroundDesert = Image.open("desert.jpg")
backgroundEarth = Image.open("earth.jpg")
backgroundField = Image.open("field.jpg")
backgroundForest = Image.open("forest.jpg")
backgroundSnowscape = Image.open("snowscape.jpg")
backgroundSunset = Image.open("sunset.jpg")

#Green Image
greenBoat = Image.open("boat.jpg")
greenCactus = Image.open("cactus.jpg")
greenSmallCat = Image.open("cat_small.jpg")
greenCat = Image.open("cat.jpg")
greenHarvester = Image.open("harvester.jpg")
greenHiker = Image.open("hiker.jpg")
greenPenguin = Image.open("penguin.jpg")
greenSpacesHuttle = Image.open("spaceshuttle.jpg")

#Convert JPG to PNG
greenBoat.save("boat.png")
greenCactus.save("cactus.png")
greenSmallCat.save("cat_small.png")
greenCat.save("cat.jpg")
greenHarvester.save("harvester.png")
greenHiker.save("hiker.png")
greenPenguin.save("penguin.png")
greenSpacesHuttle.save("spaceshuttle.png")
